...
class Validation
{
  ...
  List<_FieldsValidations> fieldsValidation = new List<_FieldsValidations>();
  ...
  /// ```
  String setRules(String value, String label, String validations, {String key})
  {
  ...
  Map<String, String> all({List<String> only, List<String> except})
  {
    ...
    {
      only.forEach((e) {
        if(fields.containsKey(e)) newFields[e] = fields[e];
      });
      return newFields;
    }
  ...
  bool _isErrorSame(String value, String param)
  {
    return value != fields[param];
  }
